...
[[nodiscard]] auto Polytropic::pressure_from_conserved(const double tau,
                                                       const double /*V*/,
                                                       const double /*EmT*/,
...
[[nodiscard]] auto Polytropic::temperature_from_conserved(const double tau, const double V,
                                                          const double E,
                                                          const double *const lambda) const
    -> double {
...
[[nodiscard]] auto Polytropic::get_gamma(const double /*tau*/, const double /*V*/, const double /*EmT*/, const double *const /*lambda*/) const noexcept -> double {
