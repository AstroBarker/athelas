...
[[nodiscard]] auto Marshak::temperature_from_conserved(const double tau, const double V,
                                                       const double E,
...
[[nodiscard]] auto Marshak::get_gamma(const double /*tau*/, const double /*V*/, const double /*EmT*/, const double *const /*lambda*/) const noexcept -> double {
  return gamma_;
}
