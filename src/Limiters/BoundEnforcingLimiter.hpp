...
void LimitInternalEnergy( View3D U, ModalBasis *Basis, EOS *eos );
void ApplyBoundEnforcingLimiter( View3D U, ModalBasis *Basis, EOS *eos );
Real ComputeThetaState( const View3D U, ModalBasis *Basis, EOS *eos,
                        const Real theta, const UInt iCF, const UInt iX,
                        const UInt iN );
Real TargetFunc( const View3D U, ModalBasis *Basis, EOS *eos, const Real theta,
